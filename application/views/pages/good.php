       ...
       <div id="panel-content">
         <?php foreach($entries as $good):?>
            <div class="panel-navigation-item clearfix">
               <a href="/<?=$catUrl?>/<?=$subCatUrl?>/<?=$good['url']?>/">
                   <img src="/images/goods/<?=$good['imageSm']?>" alt=""/>
                  <span><?=$good['name']?></span>
         ...
         <div id="myCarousel" class="carousel slide" data-ride="carousel">
            ...
            <!-- carousel-indicators -->
              <ol class="carousel-indicators">
                <?php foreach($images as $key => $image):?>
                  <li data-target="#myCarousel" data-slide-to="<?=$key?>" <?php if($key==0):?>class="active"<?php endif;?>><a href="#"><img src="/images/goods/<?=$image['image']?>" alt=""></a></li>
                <?php endforeach;?>
              </ol>
   ...
   <div class="container">
      ...
      <div class="row">
         <div class="col-md-5 col-xs-12">
            <h5><?=$entry['name']?></h5>
            <p><?=$entry['text']?></p>
            <img src="/images/goods/<?=$entry['imageSm']?>" alt="">
         </div><!-- col-md-5 end -->
